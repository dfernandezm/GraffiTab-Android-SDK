 ...
 */
public class GTMainTesting {

    public GTMainTesting() {
        // With injection
    ...
    public void uploadAvatar() {
        GTResponseHandler<GTUserResponse> responseHandler = new GTResponseHandler<GTUserResponse>() {
            ...
            @Override
            public void onSuccess(GTResponse<GTUserResponse> gtResponse) {
                GTSDK.getMeManager().editAvatar(getBitmapFromFile(), new GTResponseHandler<GTAssetResponse>() {
                    @Override
    ...
    public static void main(String[] args) throws Exception {
        GTMainTesting mainTesting = new GTMainTesting();
