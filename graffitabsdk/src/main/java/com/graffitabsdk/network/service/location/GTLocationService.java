 ...
 */
public interface GTLocationService {
    ...
    Call<GTLocationResponse> createLocation(@Body GTEditLocationData editLocationData);

    @Headers("Content-Type: application/json")
    @PUT(GTApiConstants.MY_LOCATION_ENDPOINT)
    Call<GTLocationResponse> editLocation(@Path("locationId") int locationId, @Body GTEditLocationData editLocationData);
